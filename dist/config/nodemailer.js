...
exports.nodeMailerManager = exports.transportOptions = void 0;
...
class NodemailerManager {
    sendVerifyEmail(email) {
        return __awaiter(this, void 0, void 0, function* () {
            const transporter = nodemailer.createTransport(exports.transportOptions);
    ...
    recoveryPasswordEmail(email, fullName, code) {
        return __awaiter(this, void 0, void 0, function* () {
            const transporter = nodemailer.createTransport(exports.transportOptions);
            yield transporter.sendMail({
...
exports.nodeMailerManager = new NodemailerManager();
